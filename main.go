...
func main() {
	...
	router.HandleFunc("/CreatePet", controller.CreatePet).Methods("POST")
	router.HandleFunc("/ListPets", controller.ListPets).Methods("GET")
	router.HandleFunc("/Kpis", controller.PetsKpi).Methods("GET")
